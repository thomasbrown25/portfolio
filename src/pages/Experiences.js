...
function Experiences() {
  ...
  return (
    <Layout>
      <Helmet>
        <title>Experiences - Thomas Brown Personal Portfolio </title>
        <meta
          name="description"
          content="Thomas Brown Personal Portfolio  Experiences Page"
        />
      </Helmet>
      <Suspense fallback={<Spinner />}>
        ...
        <div className="mi-resume-area mi-section mi-padding-top mi-padding-bottom">
          <div className="container">
            ...
            <div className="mt-30"></div>
            <Smalltitle title="Certifications" icon="certificate" />
            <div className="mi-resume-wrapper">
              {certificationExperience.map((certificationExp) => (
                <Resume
                  key={certificationExp.id}
                  resumeData={certificationExp}
                />
              ))}
            </div>
          </div>
